                ...
                <div class="ps-product">
                    <div class="ps-product__thumbnail"><a href="{{ route('product.details', $womens->product_slug) }}"><img src="{{ asset('uploads/products/product_thumbnail_image') }}/{{ $womens->product_thumbnail_image }}" alt=""></a>
                        ...
                        <ul class="ps-product__actions">
                            <li><a href="{{ route('product.details', $womens->product_slug) }}" data-toggle="tooltip" data-placement="top" title="Read more"><i class="icon-bag2"></i></a></li>
                            ...
                            <li><a href="{{ route('add.wish', $womens->id) }}" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        </ul>
                    </div>
                       ...
                       @endisset
                        ...
                        <div class="ps-product__content"><a class="ps-product__title" href="{{ route('product.details', $womens->product_slug) }}">{{ $womens->product_name }}</a>
                            <div class="ps-product__rating">
                                ...
                                @if(average_stars($womens->id) == 1)
                                    <option value="1">1</option>
                                @elseif(average_stars($womens->id) == 2)
                                    <option value="1">1</option>
                                    <option value="1">2</option>
                                @elseif(average_stars($womens->id) == 3)
                                    <option value="1">1</option>
                                    <option value="1">2</option>
                                    <option value="1">3</option>
                                @elseif(average_stars($womens->id) == 4)
                                    <option value="1">1</option>
                                    <option value="1">2</option>
                                    <option value="1">3</option>
                                    <option value="1">4</option>
                                @elseif(average_stars($womens->id) == 5)
                                    <option value="1">1</option>
                                    <option value="1">2</option>
                                    <option value="1">3</option>
                                    <option value="1">4</option>
                                ...
                                @endif
                            </select><span>({{ reviewCount($womens->id) }} review)</span>
                            </div>
